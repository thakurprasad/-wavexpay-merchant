      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-compact text-sm nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item {{ in_array(Request::segment(1),array('invoices','items')) ? 'menu-open' : '' }}">
                <a href="#" class="nav-link {{ in_array(Request::segment(2),array('invoices','items')) ? 'active' : '' }}"> <i class="nav-icon fas fa-list"></i> <p>Invoices <i class="right fas fa-angle-left"></i></p> </a>
                <ul class="nav nav-treeview">
            ...
            <li class="nav-item {{ in_array(Request::segment(1),array('payment-links','payment-pages')) ? 'menu-open' : '' }}">
                <a href="#" class="nav-link {{ in_array(Request::segment(2),array('payment-links','payment-pages')) ? 'active' : '' }}"> <i class="nav-icon fas fa-dollar"></i> <p>Payment Option<i class="right fas fa-angle-left"></i></p> </a>
                <ul class="nav nav-treeview">
                    <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link {{ in_array(Request::segment(1),array('reports')) ? 'active' : '' }}"> <i class="nav-icon fas fa-file"></i> <p>Reports <i class="right fas fa-angle-left"></i></p> </a>
                <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
                <a href="{{ route('customer.index') }}" class="nav-link {{ in_array(Request::segment(1),array('customer')) ? 'active' : '' }}"> <i class="nav-icon fas fa-users"></i> <p>Customers</p> </a>
            </li>
            ...
            <li class="nav-item">
                <a href="#" class="nav-link {{ in_array(Request::segment(1),array('reports')) ? 'active' : '' }}"> <i class="nav-icon fas fa-flag"></i> <p>Chargeback <i class="right fas fa-angle-left"></i></p> </a>
                <ul class="nav nav-treeview">
