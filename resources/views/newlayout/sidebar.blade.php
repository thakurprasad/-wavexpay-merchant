<ul class="navbar-nav sidebar accordion" id="accordionSidebar" style="background-color:#00008B;">
    ...
    <hr class="sidebar-divider">
    <div class="sidebar-heading">
    <span style="color:{{ in_array(Request::segment(1),array('payment-links','payment-pages')) ? '#FFFFFF;' : '' }}">Payment Option</span>
    </div>
    <li class="nav-item">
    ...
    <div id="collapseFive" class="collapse {{ in_array(Request::segment(1),array('reports')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
        <a style="color:#00008B;" class="collapse-item {{ Request::segment(1) === 'reportA' ? 'active' : null }}" href="#"><strong>Report A</strong></a>
        <a style="color:#00008B;" class="collapse-item {{ Request::segment(1) === 'reportB' ? 'active' : null }}" href="#"><strong>Report B</strong></a>
        <a style="color:#00008B;" class="collapse-item {{ Request::segment(1) === 'reportC' ? 'active' : null }}" href="#"><strong>Report C</strong></a>
        <a style="color:#00008B;" class="collapse-item {{ Request::segment(1) === 'reportD' ? 'active' : null }}" href="#"><strong>Report D</strong></a>
        <a style="color:#00008B;" class="collapse-item {{ Request::segment(1) === 'reportE' ? 'active' : null }}" href="#"><strong>Report E</strong></a>
        <a style="color:#00008B;" class="collapse-item {{ Request::segment(1) === 'reportF' ? 'active' : null }}" href="#"><strong>Report F</strong></a>
        </div>
    </div>
    </li>
    ...
    <hr class="sidebar-divider">
    <div class="sidebar-heading">
    <span style="color:{{ in_array(Request::segment(1),array('customer')) ? '#FFFFFF;' : '' }}">Customer</span>
    </div>
    ...
    <hr class="sidebar-divider">
    <div class="sidebar-heading">
    <span style="color:{{ in_array(Request::segment(1),array('pages','general-settings')) ? '#FFFFFF;' : '' }}">Settings</span>
    </div>
    <li class="nav-item">
