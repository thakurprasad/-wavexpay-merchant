<link rel="stylesheet" href="_https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
<script src="_https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
<script src="_https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
<link href="{{ url('/payment_link_popup/css/style.css') }}" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="_https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
                           ...
                           <div class="row" id="clid">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group">
                                    ...
                                    <button class="btn btn-danger " onclick="hide_popup()" type="button">Cancel</button>
                                 </div>
                              </div>
                           </div>
                     </form>
