                  ...
                  <div class="col-md-12 stage-22">
                           ...
                           <div class="form-group price stage-4 temp-4">
                              ...
                              <div class="col-auto">
                                 ...
                                 <div class="input-group mb-6">
                                    ...
                                    <span style="margin-left: 20px;">{{ $get_payment_page_details->customer_name }}</span>
                                 </div>
                              </div>
                              <div class="col-auto">
                                 ...
                                 <div class="input-group mb-6">
                                    ...
                                    <span style="margin-left: 20px;">{{ $get_payment_page_details->customer_number }}</span>
                                 </div>
                              </div>
                           </div>
                           
                           <label for="inputEmail4">Terms & Condition</label>
                           <p class="teemp-legel">{{ $get_payment_page_details->term_conditions }}</p>
                           <hr>
                     ...
                     <div class="col-md-6 stage-3-temp-3">
                        <div  id="main-view" class="slider-view">
                           ...
                           @foreach($field_details as $details)

                           @php 
                            if($details[2]!='' && is_numeric($details[2])==1)
                            {
                                $total+=$details[2];
                            }
                           @endphp
                           <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                 <input type="{{$details[1]}}" class="form-control name-text" id="exampleInputname1"  placeholder="{{ucwords($details[0])}}" value="{{$details[2]}}" @php if($details[2]!='') { echo 'readonly'; } @endphp>
                              </div>
                           </div>
                           @endforeach
                           @endif
