                     ...
                     <div class="col-md-12 stage-22">
                        <div class="col-md-5">
                           <div class="form-wave">
                              ...
                              <div class="goal-tracker-wave tooltip"><a href="#">+ Add a Goal Tracker</a> <i class="fa fa-info-circle"></i> <span class="badge bg-success">NEW</span>
                                 <span class="tooltiptext"><div class="rzp-popover-body"><div class="rzp-tooltip-title">Whats a Goal Tracker?</div>Setup and show progress of tangible goals on your Payment Page and help your audience visualise how their contributions are going.<br><br>This can also help convert potential customers and supporters by viewing progess of your goals and existing supporters.</div></span>
                        ...
                        <div class="col-md-6 stage-3-temp-3">
                           <div  id="main-view" class="slider-view">
                              ...
                              <div class="form-group row space-temp-bottom">
                              ...
                              <div class="form-group row space-temp-bottom">
                                 ...
                                 <div class="col-sm-1"></div>
                                 <div class="col-sm-8">
                                    <input type="email" class="form-control name-text" id="exampleInputemail1">
                                 </div>
                              </div>
                              <div class="form-group row space-temp-bottom">
                                 ...
                                 <div class="col-sm-1"></div>
                                 <div class="col-sm-8">
                                    <input type="phone" class="form-control name-text" id="exampleInputphone1">
                                 </div>
                              </div>
                              <div class="form-group row space-temp-bottom">
